...
function Home() {
  ...
  return (
  <main className="container mx-auto max-width pt-20 px-4 md:flex justify-between items-center">
  <div className="flex flex-col gap-4 text-center md:text-left md:w-1/2">
    ...
    <button
      ...
      className="bg-green-500 hover:bg-green-700 text-white mx-auto md:mx-0 w-fit font-bold mt-4 py-2 px-4 rounded inline-flex items-center"
    >
  ...
  <div className="mt-10 md:mt-0 flex justify-center md:justify-end md:w-1/2">
    <div className="w-40 sm:w-48 md:w-56 lg:w-64 h-40 sm:h-48 md:h-56 lg:h-64 rounded-full overflow-hidden border-4 border-green-500 shadow-lg">
      <img
        ref={myimageref}
        src={img}
        alt="Ibrahim Ahmad"
